...
from PySide6.QtCore import Qt, Signal, QTime, QRectF, QPoint, QRect, Property
from PySide6.QtGui import QIntValidator, QPainter, QPen, QPainterPath, QFont
...
class HourLineEdit(TimeLineEdit):
    ...
    def __init__(self, parent=None):
        ...
        self.setValidator(QIntValidator(0, 12))
...
class MinuteLineEdit(TimeLineEdit):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setValidator(QIntValidator(0, 59))
